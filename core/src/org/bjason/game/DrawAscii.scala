...
case class DrawAscii(normalSize:Int=32,titleSize:Int=32,flip:Boolean = true) {
  lazy val titleFont = fancyFont(titleSize,-2,flip)
  lazy val normalFont = fancyFont(normalSize,flip=flip)
  ...
  private def fancyFont(size:Int , lessX:Int = 0,flip:Boolean): BitmapFont = {
